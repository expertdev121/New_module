...
export default function PaymentPlanDialog(props: PaymentPlanDialogProps) {
  ...
  useEffect(() => {
    if (isEditMode && existingPlan && !isFormInitializedRef.current) {
      // Transform payment method to match dropdown format
      const transformedPaymentMethod = existingPlan.paymentMethod
        ? existingPlan.paymentMethod.toLowerCase().replace(/\s+/g, '_')
        : "";

      // Transform method detail to match dropdown format
      const transformedMethodDetail = existingPlan.methodDetail
        ? existingPlan.methodDetail.toLowerCase().replace(/\s+/g, '_')
        : "";
      ...
      const planData = {
        ...
        // UPDATED: Use transformed values
        paymentMethod: transformedPaymentMethod,
        methodDetail: transformedMethodDetail,
      ...
      // Set the pledgeId for pledge selector
      if (existingPlan.pledgeId && !selectedPledgeId) {
